<?php
//THIS IS THE LIS-VERSION OF THE SAME FILE IN TRIPAL_ANALYSIS_EXPRESSION MODULE
...
?>
(<span style="color:Red">NOTE: THIS IS THE LIS-VERSION OF THE SAME TEMPLATE FILE IN TRIPAL_ANALYSIS_EXPRESSION MODULE)</span><br/>
